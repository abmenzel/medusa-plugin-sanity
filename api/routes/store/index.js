...
var _customRouteHandler = _interopRequireDefault(require("./custom-route-handler"));
...
var storeRouter = (0, _express.Router)();
function getStoreRouter(storeCorsOptions) {
  storeRouter.use(cors(storeCorsOptions), bodyParser.json());
  storeRouter.post("/store/my-custom-path", (0, _medusa.wrapHandler)(_customRouteHandler["default"]));
  return storeRouter;
}